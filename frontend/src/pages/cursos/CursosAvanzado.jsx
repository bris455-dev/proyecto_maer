...
export default function CursosAvanzado() {
  ...
  return (
    <div className="cursos-nivel-container">
      ...
      <div className="cursos-nivel-header">
        <h1>Cursos Avanzado</h1>
        <p className="subtitle">Gestión de cursos de nivel Avanzado</p>
      </div>
      ...
      <div className="metricas-segmento">
        <div className="metrica-card">
          ...
          <p>Cursos Avanzado Publicados</p>
        </div>
        <div className="metrica-card">
          <h3>{kpis.total_inscritos}</h3>
          <p>Inscritos en Avanzado</p>
        </div>
        <div className="metrica-card">
          <h3>{kpis.tasa_finalizacion}%</h3>
          <p>Tasa de Finalización del Avanzado</p>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="no-cursos">
          <p>No hay cursos de nivel Avanzado disponibles.</p>
          <button 
            className="btn-crear"
            onClick={() => navigate('/cursos/nuevo?nivel=Avanzado')}
          >
            <FaPlus /> Crear Primer Curso Avanzado
          </button>
        </div>
      ) : (
        <>
