...
export default function CursosIntermedio() {
  ...
  return (
    <div className="cursos-nivel-container">
      ...
      <div className="cursos-nivel-header">
        <h1>Cursos Intermedio</h1>
        <p className="subtitle">Gestión de cursos de nivel Intermedio</p>
      </div>
      ...
      <div className="metricas-segmento">
        <div className="metrica-card">
          ...
          <p>Cursos Intermedio Publicados</p>
        </div>
        <div className="metrica-card">
          <h3>{kpis.total_inscritos}</h3>
          <p>Inscritos en Intermedio</p>
        </div>
        <div className="metrica-card">
          <h3>{kpis.tasa_finalizacion}%</h3>
          <p>Tasa de Finalización del Intermedio</p>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="no-cursos">
          <p>No hay cursos de nivel Intermedio disponibles.</p>
          <button 
            className="btn-crear"
            onClick={() => navigate('/cursos/nuevo?nivel=Intermedio')}
          >
            <FaPlus /> Crear Primer Curso Intermedio
          </button>
        </div>
      ) : (
        <>
